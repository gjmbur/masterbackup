...
ssc install scheme_g538schemes
ssc install scheme_plotplain
ssc install scheme-burd
foreach `scheme' of tufte lean blind 538 plotplain {
	ssc install scheme_`scheme'
}
* Lecture 1. 
...
* Lecture 5
	...
	* Change to Fa22: made the data-cleaning much simpler for NHANES. 
	
	capture mkdir ./data/nhanes
	#delimit ; 
